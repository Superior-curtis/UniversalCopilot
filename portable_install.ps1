...
# Note: When called from batch installer, files are already copied
# Skip if files already exist in install dir (sign that batch already did the copy)
if (-Not (Test-Path $installDir)) {
    New-Item -ItemType Directory -Path $installDir | Out-Null
    
    # Only copy files if they don't already exist (batch installer should have done this)
